...
export const SHADCN_RULES_STYLING = `# Styling & Customization
...
export const SHADCN_RULES_COMPOSITION = `# Component Composition
...
export const SHADCN_RULES_FORMS = `# Forms & Inputs
...
export const SHADCN_RULES_ICONS = `# Icons
...
export const SHADCN_RULES_BASE_VS_RADIX = `# Base vs Radix
...
export const SHADCN_CUSTOMIZATION = `# Customization & Theming
