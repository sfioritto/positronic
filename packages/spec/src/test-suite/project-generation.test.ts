 ...
 *
 * These tests verify that backend implementations correctly handle:
 * - Full project creation with real templates
 * - Verification of .positronic directory structure (or equivalent)
 * - Manifest generation from brain files
 * - Configuration file handling
 * - Environment setup
 *
 * TODO: Refactor these tests to work with any backend via the ComplianceTestConfig
 */
...
// describe('Backend Compliance: Project Generation', () => {
//   let tempDir: string;
