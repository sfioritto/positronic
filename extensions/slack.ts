...
declare module "../dsl/blocks" {
  interface Workflow<TOptions, TContext> {
    slack: {
      message(
        title: string,
        config: {
      ...
      ): Workflow<TOptions, Expand<TContext & { lastSlackMessage: SlackMessage }>>;
      ...
      ): Workflow<TOptions, Expand<TContext & { lastSlackNotification: SlackNotification }>>;
    }
  }
}
